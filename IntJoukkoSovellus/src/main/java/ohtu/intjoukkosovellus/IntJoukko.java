...
public class IntJoukko {
    ...
    public IntJoukko() {
        lukujono = teeLukujono(KAPASITEETTI);
        alkioidenLkm = 0;
    ...
    public int[] teeLukujono(int kapasiteetti) {
    ...
    private void suurennaTaulukkoa(int[] vanha) {
        int[] uusiTaulukko = teeLukujono(alkioidenLkm + kasvatuskoko);
